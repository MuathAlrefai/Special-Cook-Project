...
public class IngredientSuggestionChefStepsTest 
{
    ...
    public void setUp() 
    {
        ...
        context.customerManager.registerCustomer("Ameer");
        Customer customer = context.customerManager.getCustomer("Ameer");
    ...
    public void testSuggestAlternativesForAllergies()
    {
        ...
        context.suggestedAlternatives = context.customerManager.suggestAlternatives("Ameer", ingredients);
